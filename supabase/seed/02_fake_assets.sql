...
BEGIN
  ...
  INSERT INTO assets (
    ...
    spoc_agent, plot_size_sqm, fsi_potential, regulations,
  ...
  (
    ...
    'Ramesh Nair', 2450.00, 3.000, ARRAY['33(7)'],
  ...
  (
    ...
    'Priya Shah', 5200.00, 2.500, ARRAY['33(7B)', '33(20B)'],
  ...
  (
    ...
    'Amit Joshi', 800.00, 5.000, ARRAY['30(A)'],
  ...
  (
    ...
    'on_hold', 'cold', 'sra',
    'Deepak Verma', 12000.00, 4.000, ARRAY['33(10)', '33(7)'],
  ...
  (
    ...
    'new', 'none', 'open_land',
    'Kavita Menon', 18500.00, 1.500, ARRAY['UDCPR'],
